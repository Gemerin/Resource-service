...
try {
    ...
    // Parse requests of the content type application/json. Limits the size of the JSON payloads to 500kb. 
    // If a JSON payload exceeds this limit, a 413 error is sent.
